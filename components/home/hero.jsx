  ...
  return (
    <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 overflow-x-auto pb-4 mb-8 mt-50 scrollbar-hide">
          {[
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          ...
          {selectedCategory === "Pool & spa" && [
            {
              title: "Pool Cleaning",
              image: "https://images.unsplash.com/photo-1563491375-d129700f11d5?w=1920&h=1080&fit=crop&q=90",
            },
            {
              title: "Pool Repair",
              image: "https://images.unsplash.com/photo-1576610616656-d3aa24d1a3e1?w=1920&h=1080&fit=crop&q=90",
            },
            {
            ...
            },
            {
              ...
              image: "https://images.unsplash.com/photo-1600607687644-c7171b42498b?w=1920&h=1080&fit=crop&q=90",
            },
          ].map((service, index) => (
            <div
              key={index}
        ...
        <div className="mt-60 mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              {[
                ...
                <button
                  ...
                  className={`w-full text-left p-6 rounded-[30px] cursor-pointer transition-all duration-500 ease-in-out transform ${
                    activeTab === tab.id
                      ? "border-2 border-black dark:border-white bg-white dark:bg-black scale-105 shadow-lg"
                  ...
                  style={{
                    animation: activeTab === tab.id ? 'pulse 2s ease-in-out infinite' : 'none'
                  }}
                >
                  <h3 className={`text-2xl sm:text-3xl md:text-4xl font-bold mb-3 transition-all duration-500 ${
                    activeTab === tab.id
                      ? "text-black dark:text-white transform translate-x-2"
            ...
            <div className="relative flex justify-center lg:justify-end order-1 lg:order-2 min-h-[700px]">
